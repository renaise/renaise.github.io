...
export const projectsExpanded: ProjectExpanded[] = [
  ...
  },
  {
    ...
    stage: {
      title: 'Aputure',
      subtitle: 'Global site for professional lighting',
    ...
    lab: {
      title: 'DON\'T DESIGN FOR HEADQUARTERS',
    ...
    serviceSuite: ['Strategy', 'Identity', 'Design', 'Production'],
    priority: 4,
  },
  {
    id: 'flora',
    ...
    lab: {
      title: 'BUILDING WITHOUT A PLAYBOOK',
  ...
  },
  {
    ...
    lab: {
      title: 'WHY HANDOFFS BREAK',
      subtitle: 'Eliminating design-to-engineering friction',
      context: 'The design-to-engineering handoff is one of the most complained-about moments in product development. Tools have tried to solve it for a decade—Zeplin, Figma Dev Mode, countless plugins. Yet teams still struggle. The problem keeps getting "solved" without going away.',
    ...
    serviceSuite: ['Strategy', 'Design', 'Production'],
    priority: 6,
  },
  {
    id: 'rememe',
